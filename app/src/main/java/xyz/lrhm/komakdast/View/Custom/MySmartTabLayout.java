...
public class MySmartTabLayout extends HorizontalScrollView {
    ...
    public MySmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId = a.getResourceId(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_defaultTabBackground, tabBackgroundResId);
        textAllCaps = a.getBoolean(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_defaultTabTextAllCaps, textAllCaps);
        textColors = a.getColorStateList(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_defaultTabTextColor);
        textSize = a.getDimension(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_defaultTabTextSize, textSize);
        textHorizontalPadding = a.getDimensionPixelSize(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_defaultTabTextHorizontalPadding, textHorizontalPadding);
        textMinWidth = a.getDimensionPixelSize(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_defaultTabTextMinWidth, textMinWidth);
        customTabLayoutId = a.getResourceId(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_customTabTextLayoutId, customTabLayoutId);
        customTabTextViewId = a.getResourceId(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_customTabTextViewId, customTabTextViewId);
        distributeEvenly = a.getBoolean(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_distributeEvenly, distributeEvenly);
        clickable = a.getBoolean(
                xyz.lrhm.komakdast.R.styleable.stl_SmartTabLayout_stl_clickable, clickable);
