...
import ir.iut.komakdast.Adapter.Cache.ContactsCacheHolder;
...
//        onNewContact(contactsHolders.poll());
    ...
    public void onNewContact(final ContactsHolder contactsHolder) {
        ...
        AppAPIAdapter.updateContact(contactsHolder, new Callback<HashMap<String, String>>() {
            @Override
