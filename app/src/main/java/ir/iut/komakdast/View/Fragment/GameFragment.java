...
import ir.iut.komakdast.Adapter.TimeStampAdapter;
...
import ir.iut.komakdast.View.Dialog.ImageFullScreenDialog;
...
//                        .putCustomAttribute("PackageName", "package " + packageId));
        ...
        imagePath = "file://" + getActivity().getFilesDir().getPath() + "/Packages/package_" + packageId + "/" + level.getAnswer();
