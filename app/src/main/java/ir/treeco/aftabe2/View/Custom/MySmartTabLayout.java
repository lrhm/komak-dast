...
public class MySmartTabLayout extends HorizontalScrollView {
    ...
    public MySmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId = a.getResourceId(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_defaultTabBackground, tabBackgroundResId);
        textAllCaps = a.getBoolean(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_defaultTabTextAllCaps, textAllCaps);
        textColors = a.getColorStateList(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_defaultTabTextColor);
        textSize = a.getDimension(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_defaultTabTextSize, textSize);
        textHorizontalPadding = a.getDimensionPixelSize(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_defaultTabTextHorizontalPadding, textHorizontalPadding);
        textMinWidth = a.getDimensionPixelSize(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_defaultTabTextMinWidth, textMinWidth);
        customTabLayoutId = a.getResourceId(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_customTabTextLayoutId, customTabLayoutId);
        customTabTextViewId = a.getResourceId(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_customTabTextViewId, customTabTextViewId);
        distributeEvenly = a.getBoolean(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_distributeEvenly, distributeEvenly);
        clickable = a.getBoolean(
                ir.treeco.aftabe2.R.styleable.stl_SmartTabLayout_stl_clickable, clickable);
